/*
  ...
  // required
  OptionButton(Adafruit_ILI9341 *Display) {d = Display; }
...
void setup() {
  ...
  OBA.init(C_WHITE, C_GREEN, C_DKGREY, C_WHITE, C_BLACK, 0, 0, FONT_SBUTTON );
  ...
  OBB.init(C_WHITE, C_GREEN, C_DKGREY, C_WHITE, C_DKGREY, 0, 0, FONT_SBUTTON );
  ...
  CB1.init(COL1, ROW5, C_WHITE, C_GREEN, C_DKGREY, C_WHITE, C_BLACK, 0, 0, "Enable", FONT_SBUTTON );
  CB2.init(COL2, ROW5, C_WHITE, C_GREEN, C_DKGREY, C_WHITE, C_BLACK, 0, 0, "Show", FONT_SBUTTON );
